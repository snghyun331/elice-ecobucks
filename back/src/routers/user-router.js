...
userAuthRouter.post("/register", userValidation, userController.PostUser_register);
...
userAuthRouter.put("/mypage/useredit/:_id", login_required, userValidation, userController.userPutMypage)
