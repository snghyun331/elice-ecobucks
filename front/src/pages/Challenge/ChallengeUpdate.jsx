...
const ChallengeUpdate = ({ challenge }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // You can add the necessary logic to update the challenge
    } catch (err) {
    ...
    <div>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group controlId="duration">
          ...
          <Container className="text-muted" style={{ fontSize: "0.85rem" }}></Container>
        ...
        <Form.Group controlId="icon">
          ...
          <Container className="text-muted" style={{ fontSize: "0.85rem" }}>
            챌
린지에 어울리는 테마 아이콘을 설정해주세요. 대표 이미지로 나타납니다.
          </Container>
          <ButtonGroup>
            <Button
